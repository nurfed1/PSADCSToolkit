@{
    ...
    GUID                 = 'faac968f-89c0-4cb9-84a0-0606225a4d59'

    # Author of this module
    Author               = 'Bryan De Houwer'
    ...
    Description          = 'This module manages ADCS Certificate Templates'
    ...
    TypesToProcess = @(
        # We can't load types here...
        # powershell doesn't know about our custom types (enums/classes)
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            LicenseUri   = 'https://github.com/nurfed1/PSADCSToolkit/blob/master/LICENSE'

            # A URL to the main website for this project.
            ProjectUri   = 'https://github.com/nurfed1/PSADCSToolkit'
